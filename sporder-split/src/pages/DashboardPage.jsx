...
export default function DashboardPage({ onJoin, onCreate, onExportAll, showToast }) {
  const { allEvents, filteredEvents } = useEvents(); // Używamy obu list
        ...
        <div className="grid gap-4 p-6 md:grid-cols-[1.3fr_1fr]">
          <div>
            ...
            <p className="text-[var(--muted)]">
              SPORDER łączy ludzi, którzy chcą razem trenować. Wybierz sport, poziom, lokalizację i dołącz do ekipy. Twórz też własne wydarzenia!
            </p>
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2 md:grid-cols-3">
              <Card className="p-3"><div className="text-xl font-extrabold">{kpiEvents}</div><div className="text-sm text-[var(--muted)]">Wydarzeń w okolicy</div></Card>
